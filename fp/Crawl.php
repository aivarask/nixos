...
class Crawl
{
  ...
  {
    echo $this->twig->render('search.twig', ['sname' => $_REQUEST['sname'], 'items' => self::$search_items, 'total' => $this->total, 'perPage' => $this->perPage]);
  }
  ...
  private function searchExtract(ResponseInterface $res)
  {
    ...
    $this->total = $xpath->query('//div[@id="product_category_filter_container"]//span[@class="mr15"]')->item(0)->textContent ?? null;
