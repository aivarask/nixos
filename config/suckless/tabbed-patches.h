 ...
 * You need to uncomment the corresponding line in Makefile to use the -lXrender
 * library when including this patch.
...
/* Only show the basename of the tabbed title; useful with zathura. Toggle with
 * -b. https://tools.suckless.org/tabbed/patches/basenames/
 */
...
/* Expansion of the resources patch above, allows resources to be reloaded
 * during runtime by using a USR1 kill signal.
 *
 * Example use:
