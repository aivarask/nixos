...
require "lspconfig".jsonls.setup { --- @see vscode-langservers-extracted
  capabilities = capabilities, settings = { json = json(), },
}
vim.api.nvim_create_autocmd({ "BufWritePre", }, { group = "Format", desc = "jsonls", pattern = { "*.json", "*.jsonc", }, callback = function() vim.lsp.buf.format() end, })
